package com.services.tunnel.vpn;
...
public class TunnelVpnManager implements Tunnel.HostService
{
	...
	{
		SharedPreferences prefs = new Setting(getContext()).getPrefsPrivate();
	...
	{
	//	SkStatus.logInfo("<strong><font color='#3eb489'>SSH Connected</font></strong>");
	}
	...
	{
	//	SkStatus.logInfo("<strong><font color='#3eb489'>SSH Established</font></strong>");
