...
import com.chadx.injector.util.BufferSizeDialog;
import com.chadx.injector.MainApp;
...
SkStatus.StateListener
{
	...
	OPEN_SETTINGS_DNS = "openDNSScreen",
	...
	public boolean onPreferenceChange(Preference pref, Object newValue)
	{
		switch (pref.getKey()) {
			...
			case IDIOMA_KEY:
				...
				if (((String)newValue).equals(new Setting(getContext())
											  .getIdioma())) {
					return false;
				}
