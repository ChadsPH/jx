		...
		implements CompoundButton.OnCheckedChangeListener, View.OnClickListener
{
	...
	private void exportConfiguracao(String nome)
		...
		//File fileDir = new File(Environment.getExternalStorageDirectory(), "HTTP Tunnel");

		//File fileDir = new 	File(String.valueOf(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)));


		File fileDir = new 	File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS), "HTTP Ajax");
		...
		File fileExport = new File(fileDir, String.format("%s.%s", nome, "pcx"));
